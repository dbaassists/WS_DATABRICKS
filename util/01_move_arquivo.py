...
var_diretorio_arquivo  = '/dbfs/mnt/dados/landing_zone/workshop'
...
for est in list_dir:
  ...
  if os.path.isfile(var_diretorio_arquivo + '//' + est):
    ...
    if ((os.path.splitext(est)[1]=='.xlsx') | (os.path.splitext(est)[1]=='.csv')) and (os.path.isfile(f'/dbfs/mnt/dados/landing_zone/workshop/{est}')):
